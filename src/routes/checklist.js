...
router.get('/:id/edit', async (req, res) => {
    try {
        ...
        res.status(500).render('pages/error', { erros: 'Erro ao exibir a edição da Lista de Tarefas'});
    }
})
...
router.get('/:id', async (req, res) => {
    try {
        ...
        res.status(200).render('pages/error/index', { error: 'Erro ao exibir as Listas de tarefas'})
